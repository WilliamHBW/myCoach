...
import { analyzeWorkoutRecord, updatePlanWithRecords, PlanUpdateResult } from '../../services/ai'
...
import { getCompletionData, formatDate } from '../../utils/planDateMatcher'
import './index.scss'
...
export default function RecordList() {
  ...
  const { records, updateRecordAnalysis, deleteRecord } = useRecordStore()
  ...
  const handleUpdatePlan = async () => {
    ...
    // 检查计划周期内是否有记录
    const completionData = getCompletionData(currentPlan, records)
    ...
    try {
      const result = await updatePlanWithRecords(currentPlan, records)
